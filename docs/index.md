...
- [1 Introduction](https://bellard.org/quickjs/quickjs.html#Introduction)
  - [1.1 Main Features](https://bellard.org/quickjs/quickjs.html#Main-Features)
- [2 Usage](https://bellard.org/quickjs/quickjs.html#Usage)
  - [2.1 Installation](https://bellard.org/quickjs/quickjs.html#Installation)
  - [2.2 Quick start](https://bellard.org/quickjs/quickjs.html#Quick-start)
  - [2.3 Command line options](https://bellard.org/quickjs/quickjs.html#Command-line-options)
    - [2.3.1 `qjs` interpreter](https://bellard.org/quickjs/quickjs.html#qjs-interpreter)
    - [2.3.2 `qjsc` compiler](https://bellard.org/quickjs/quickjs.html#qjsc-compiler)
  - [2.4 `qjscalc` application](https://bellard.org/quickjs/quickjs.html#qjscalc-application)
  - [2.5 Built-in tests](https://bellard.org/quickjs/quickjs.html#Built_002din-tests)
  - [2.6 Test262 (ECMAScript Test Suite)](https://bellard.org/quickjs/quickjs.html#Test262-_0028ECMAScript-Test-Suite_0029)
- [3 Specifications](https://bellard.org/quickjs/quickjs.html#Specifications)
  - [3.1 Language support](https://bellard.org/quickjs/quickjs.html#Language-support)
    - [3.1.1 ES2023 support](https://bellard.org/quickjs/quickjs.html#ES2023-support)
    - [3.1.2 ECMA402](https://bellard.org/quickjs/quickjs.html#ECMA402)
    - [3.1.3 Extensions](https://bellard.org/quickjs/quickjs.html#Extensions)
    - [3.1.4 Mathematical extensions](https://bellard.org/quickjs/quickjs.html#Mathematical-extensions)
  - [3.2 Modules](https://bellard.org/quickjs/quickjs.html#Modules)
  - [3.3 Standard library](https://bellard.org/quickjs/quickjs.html#Standard-library)
    - [3.3.1 Global objects](https://bellard.org/quickjs/quickjs.html#Global-objects)
    - [3.3.2 `std` module](https://bellard.org/quickjs/quickjs.html#std-module)
    - [3.3.3 `os` module](https://bellard.org/quickjs/quickjs.html#os-module)
  - [3.4 QuickJS C API](https://bellard.org/quickjs/quickjs.html#QuickJS-C-API)
    - [3.4.1 Runtime and contexts](https://bellard.org/quickjs/quickjs.html#Runtime-and-contexts)
    - [3.4.2 JSValue](https://bellard.org/quickjs/quickjs.html#JSValue)
    - [3.4.3 C functions](https://bellard.org/quickjs/quickjs.html#C-functions)
    - [3.4.4 Exceptions](https://bellard.org/quickjs/quickjs.html#Exceptions)
    - [3.4.5 Script evaluation](https://bellard.org/quickjs/quickjs.html#Script-evaluation)
    - [3.4.6 JS Classes](https://bellard.org/quickjs/quickjs.html#JS-Classes)
    - [3.4.7 C Modules](https://bellard.org/quickjs/quickjs.html#C-Modules)
    - [3.4.8 Memory handling](https://bellard.org/quickjs/quickjs.html#Memory-handling)
    - [3.4.9 Execution timeout and interrupts](https://bellard.org/quickjs/quickjs.html#Execution-timeout-and-interrupts)
- [4 Internals](https://bellard.org/quickjs/quickjs.html#Internals)
  - [4.1 Bytecode](https://bellard.org/quickjs/quickjs.html#Bytecode)
  - [4.2 Executable generation](https://bellard.org/quickjs/quickjs.html#Executable-generation)
    - [4.2.1 `qjsc` compiler](https://bellard.org/quickjs/quickjs.html#qjsc-compiler-1)
    - [4.2.2 Binary JSON](https://bellard.org/quickjs/quickjs.html#Binary-JSON)
  - [4.3 Runtime](https://bellard.org/quickjs/quickjs.html#Runtime)
    - [4.3.1 Strings](https://bellard.org/quickjs/quickjs.html#Strings)
    - [4.3.2 Objects](https://bellard.org/quickjs/quickjs.html#Objects)
    - [4.3.3 Atoms](https://bellard.org/quickjs/quickjs.html#Atoms)
    - [4.3.4 Numbers](https://bellard.org/quickjs/quickjs.html#Numbers)
    - [4.3.5 Garbage collection](https://bellard.org/quickjs/quickjs.html#Garbage-collection)
    - [4.3.6 JSValue](https://bellard.org/quickjs/quickjs.html#JSValue-1)
    - [4.3.7 Function call](https://bellard.org/quickjs/quickjs.html#Function-call)
  - [4.4 RegExp](https://bellard.org/quickjs/quickjs.html#RegExp)
  - [4.5 Unicode](https://bellard.org/quickjs/quickjs.html#Unicode)
  - [4.6 BigInt, BigFloat, BigDecimal](https://bellard.org/quickjs/quickjs.html#BigInt_002c-BigFloat_002c-BigDecimal)
- [5 License](https://bellard.org/quickjs/quickjs.html#License)

## 1 Introduction

QuickJS is a small and embeddable Javascript engine. It supports most of the ES2023 specification [^1^](https://bellard.org/quickjs/quickjs.html#FOOT1) including modules, asynchronous generators, proxies and BigInt.
...
- Fast interpreter with very low startup time: runs the 77000 tests of the ECMAScript Test Suite[^2^](https://bellard.org/quickjs/quickjs.html#FOOT2) in less than 2 minutes on a single core of a desktop PC. The complete life cycle of a runtime instance completes in less than 300 microseconds.
- Almost complete ES2023 support including modules, asynchronous generators and full Annex B support (legacy web compatibility). Some features from the upcoming ES2024 specification [^3^](https://bellard.org/quickjs/quickjs.html#FOOT3) are also supported.
...
The configuration files `test262.conf` (resp. `test262o.conf` for the old ES5.1 tests[^4^](https://bellard.org/quickjs/quickjs.html#FOOT4))) contain the options to run the various tests. Tests can be excluded based on features or filename.
...
`run-test262` accepts the `-N` option to be invoked from `test262-harness`[^5^](https://bellard.org/quickjs/quickjs.html#FOOT5) thru `eshost`. Unless you want to compare QuickJS with other engines under the same conditions, we do not recommend to run the tests this way as it is much slower (typically half an hour instead of about 100 seconds).
...
- Tail calls[^6^](https://bellard.org/quickjs/quickjs.html#FOOT6)
...
BigInt, BigFloat and BigDecimal are implemented with the `libbf` library[^7^](https://bellard.org/quickjs/quickjs.html#FOOT7). It weights about 90 KiB (x86 code) and provides arbitrary precision IEEE 754 floating point operations and transcendental functions with exact rounding.
...
### [(1)](https://bellard.org/quickjs/quickjs.html#DOCF1)

<https://tc39.es/ecma262/2023>

### [(2)](https://bellard.org/quickjs/quickjs.html#DOCF2)

<https://github.com/tc39/test262>

### [(3)](https://bellard.org/quickjs/quickjs.html#DOCF3)

<https://tc39.es/ecma262/>

### [(4)](https://bellard.org/quickjs/quickjs.html#DOCF4)
